...
Page({
  ...
  loadData: function () {
    var datas = [];
    manager_mgr.allSiteInfo().then(result_data => {
  ...
  viewDetailHandler: function (event) {
    //能够获取到整个view的值
    var time_book = event.currentTarget.dataset.time
    var site_book = event.currentTarget.dataset.site
    var siteinfo_sign = site_book + time_book
